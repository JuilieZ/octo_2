...
class PullCubeEnv(BaseEnv):
    ...
    **Success Conditions:**
    ...
    def __init__(self, *args, robot_uids="rm75_wristcam", robot_init_qpos_noise=0.02, **kwargs):
        ...
        self.observation_space = gym.spaces.Dict(
            {
                ...
                "proprio": gym.spaces.Box(
                    low=np.ones((11,)) * -1, high=np.ones((11,)), dtype=np.float32
                ),
            }
        )
    ...
    def get_task(self):
        return {
            "language_instruction": ['pull the cube to the target goal position'],
        }
...
python examples/02_finetune_new_observation_action.py --pretrained_path=hf://rail-berkeley/octo-small-1.5 --data_dir=/home/server/octo/aloha_sim_dataset  --save_dir=/home/server/octo/checkpoint_act
"""
...
def main(_):
    ...
    wandb.init(name="finetune_rm75_without_norm", project="octo")
    ...
    dataset = make_single_dataset(
        dataset_kwargs=dict(
            name="pickcube_pd_ee_target_pose",
    ...
    del config["model"]["observation_tokenizers"]["primary"]
    ...
    config["model"]["observation_tokenizers"]["proprio"] = ModuleSpec.create(
        ...
        low=-3.14,
        high=-3.14,
        # low = [-0.321327269077301, -0.367645263671875, -0.4096109867095947, 0.7416614294052124, -0.0795075073838234, 0.8484946489334106, -3.785545825958252, 0.42994749546051025, 0.4499936103820801, 0.5820382833480835, 0.5695065855979919],
        # high = [0.3375815451145172, 0.5434966087341309, 0.3613700866699219, 2.3560104370117188, 0.07008358091115952, 2.233999252319336, -2.5039455890655518, 0.8000295758247375, 0.8000307679176331, 0.800000011920929, 0.800000011920929],
        obs_keys=["proprio"],
    )
    ...
    with open(config_path, "w") as f:
        json.dump(config, f, indent=4)  # indent=4 格式化输出，方便阅读

...
def main(_):
    ...
    wandb.init(name="finetune_maniskill", project="octo")
    ...
    # check it if usable for rm75_dataset
    ...
    # ds = b.as_dataset(split='train[:100]').shuffle(100)   # take only first 10 episodes
    # train_data_iter = (
    #     ds.repeat()
    #     .unbatch()
    #     .shuffle(100)  # can reduce this if RAM consumption too high
    ...
    for i in tqdm.tqdm(range(1), total=1, dynamic_ncols=True):
        print(">>>>>>>>>>",i)
        batch = next(train_data_iter)
        # print(">>>>>.batch",batch)
        # print(">>>>>.batch",train_state)

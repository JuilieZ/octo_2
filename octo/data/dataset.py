...
def make_dataset_from_rlds(
    ...
    *,
    ...
    if isinstance(dataset_statistics, str):
        ...
        # print(">>>proprio_obs_key",str(proprio_obs_key))
        # print(">>>builder.info",str(builder.info))
    ...
    # print(">>>dataset_statistics",str(dataset_statistics))
    ...
    if "val" not in builder.info.splits:
        split = "train[:95%]" if train else "train[5%:]"
    else:
